...
if __name__ == '__main__':
    ...
    for i, (images, labels, cont_labels, name) in enumerate(test_loader):
        ...
        if args.save_viz:
            ...
            os.makedirs('C:\\Users\\Girish\\Desktop\\FF-Projects\\deep-head-pose\\output\\onnxHopenet8bit_images', exist_ok=True)
            ...
            plt.savefig(os.path.join('C:\\Users\\Girish\\Desktop\\FF-Projects\\deep-head-pose\\output\\onnxHopenet8bit_images', name + '.jpg'), bbox_inches='tight')
            plt.close()
