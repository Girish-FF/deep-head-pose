...
if __name__ == '__main__':
    ...
    csv_file_path = os.path.split(snapshot_path)[1].split('.')[0]
    # ResNet50 structure
    ...
    for i, (images, name) in enumerate(test_loader):
        ...
        if args.save_viz:
            ...
            os.makedirs(f'C:\\Users\\Girish\\Desktop\\FF-Projects\\deep-head-pose\\output\\{csv_file_path}', exist_ok=True)
            ...
            # plt.savefig(os.path.join(f'C:\\Users\\Girish\\Desktop\\FF-Projects\\deep-head-pose\\output\\{csv_file_path}', name + '.jpg'), bbox_inches='tight')
            # plt.close()
    ...
    # print(snapshot_path.split())
    
    print(df_common_paths)
    # df_common_paths.to_csv(f'.\output\{csv_file_path}.csv', index=False)
